...
class PostController extends AbstractController
{
    ...
    public function index2(UserRepository $repository, Request $request): Response
    {
        ...
        $forms = [];
        $form = $this->createForm(CommentType::class, $commentaire);
        return $this->render('publicationsU/MesPublication.html.twig', ['now' => $now, 'pubs' => $pubs, 'form' => $form->createView()]);
    }
...
//                        dd($filename);
        ...
        return $this->render('publicationsU/repost.html.twig', ['pub1' => $pub1, 'form' => $form->createView(), 'form1' => $form1->createView()]);
    }
...
//        $em->persist($comment);
     ...
     * @throws Exception
     */
    public function editPub($id, Request $request, UserRepository $repository, PublicationRepository $rep, MutimediaRepository $multi): Response
    {
        $pub = $rep->find($id);
        $mul = $multi->find($id);
...
//            return $this->redirectToRoute("post");
        ...
        return $this->render('publicationsU/editPub.html.twig', ['form' => $form->createView(), 'form1' => $form1->createView()]);
    }
    /**
